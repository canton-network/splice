...
grafana_domain_link="${grafana_base}/d/ca9df344-c699-4efe-83c2-5fb2639d96d9/global-domain-catchup?orgId=1&from=${start_time}&to=${end_time}&timezone=UTC&var-DS=prometheus&var-namespace=${namespace}&var-migration=All&refresh=30s"
grafana_participant_link="${grafana_base}/d/edkzo5ukgeqyoc/participant?orgId=1&from=${start_time}&to=${end_time}&timezone=UTC&var-namespace=${namespace}&var-job=All&var-participant=All&refresh=5m"
...
*Dashboards:*
• <${grafana_domain_link}|Global Domain Catchup>
• <${grafana_participant_link}|Participant>"
