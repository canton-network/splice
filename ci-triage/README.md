...
| `ray/fix-multiarch-check-retry` | 4dc7d6c36d | 10150 / 10172: `check-multiarch-images.py` retries skopeo 3x and reports the manifest shape on a non-index answer | py_compile only |
