...
class BftScanConnection(
  ...
  def getAllocationV2CancelContextRaw(
    ...
    bftCall(_.getAllocationV2CancelContextRaw(allocationId, body), "getAllocationV2CancelContextRaw")
  ...
  def getAllocationWithdrawContextV2(
    ...
    bftCall(_.getAllocationWithdrawContextV2(allocationCid), "getAllocationWithdrawContextV2")
