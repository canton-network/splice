...
object SvOnboardingConfig {
  case class FoundDso(
      ...
      // Networks default to FeaturedAppMarkers (initialRewardConfig = None).
      // Tests default to TrafficBasedAppRewards via a config transform in ConfigTransforms.defaults();
