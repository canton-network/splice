...
export const Governance: React.FC = () => {
  ...
  }, [voteRequests, alreadyVotedRequestIds, amuletName, currentSvName]);
  ...
  }, [voteRequests, votingThreshold, alreadyVotedRequestIds, amuletName, svPartyId]);
  ...
  const actionRequiredRequests = useMemo(
    () => filterByContractId(actionRequiredBase, searchQuery),
    [actionRequiredBase, searchQuery]
  );

  const inflightRequests = useMemo(
    () => filterByContractId(inflightBase, searchQuery),
    [inflightBase, searchQuery]
  );
  ...
  const searchVoteHistoryBase = useMemo(() => {
    ...
    return buildVoteHistoryData(searchVoteResults.results, amuletName, svPartyId, votingThreshold);
  }, [searchVoteResults.results, amuletName, svPartyId, votingThreshold]);
